...
# === IMAGES ===
bg_image = pygame.image.load("oceanbg.png").convert()
bg_image = pygame.transform.scale(bg_image, (MAP_WIDTH, MAP_HEIGHT))
skimmer_img = pygame.image.load("skimmer.png").convert_alpha()
skimmer_img = pygame.transform.scale(skimmer_img, (50,50))
oil_spill_img = pygame.image.load("oil-removebg-preview.png").convert_alpha()
game_over_img = pygame.image.load("gameover.png").convert()
game_cleared_img = pygame.image.load("gamecleared.png").convert()
swimmer_img = pygame.image.load("swimmer.png").convert_alpha()
